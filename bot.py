...
TEXTS = {
    "ru": {
        ...
        "vacancies": [["Бетонщик"], ["Бригадир"], ["Сварщик 141 метод"], ["Сборщик"], ["Электрик"], ["Оператор вилочного погрузчика"], ["Сборщик труб"]],
    },
    "en": {
        ...
        "vacancies": [["Concrete worker"], ["Foreman"], ["Welder 141 method"], ["Assembler"], ["Electrician"], ["Forklift operator"], ["Pipe fitter"]],
    },
}
